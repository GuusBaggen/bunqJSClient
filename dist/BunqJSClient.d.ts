...
export default class BunqJSClient {
     ...
     */
    constructor(storageInterface?: StorageInteface | false, loggerInterface?: LoggerInterface);
    /**
     * Starts the client and sets up the required components
     * @returns {Promise.<void>}
     */
    run(apiKey: string | false, allowedIps?: string[], environment?: string, encryptionKey?: string | boolean, bitSize?: number, ignoreCi?: boolean): Promise<void>;
    /**
     ...
     */
    setRequestProxies(enabledProxies: RequestLimitProxyTypes): void;
    /**
     ...
     * @returns {Promise<boolean>}
     */
    registerDevice(deviceName?: string, bitSize?: number, ignoreCi?: boolean): Promise<boolean>;
    /**
     ...
     */
    setExpiryTimer(deprecatedParameter?: boolean, ignoreCi?: boolean): boolean;
    /**
