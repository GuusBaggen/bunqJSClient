...
class Ip {
    ...
    async get(userId, credentialPasswordIpId, ipId, options = {}) {
        ...
        const response = await limiter.run(async (axiosClient) => this.ApiAdapter.get(`/v1/user/${userId}/credential-password-ip/${credentialPasswordIpId}/ip/${ipId}`, {}, {}, axiosClient));
    ...
    async list(userId, credentialPasswordIpId, options = {
        ...
        const response = await limiter.run(async (axiosClient) => this.ApiAdapter.get(`/v1/user/${userId}/credential-password-ip/${credentialPasswordIpId}/ip`, {}, {
            axiosOptions: {
                params: params
            }
        }, axiosClient));
    ...
    async post(userId, credentialPasswordIpId, ip, status, options = {}) {
        ...
        const response = await limiter.run(async (axiosClient) => this.ApiAdapter.post(`/v1/user/${userId}/credential-password-ip/${credentialPasswordIpId}/ip`, data, {}, {}, axiosClient));
        return response.Response;
    }
    /**
     * @param {number} userId
    ...
    async put(userId, credentialPasswordIpId, ipId, ip, status, options = {}) {
        ...
        const response = await limiter.run(async (axiosClient) => this.ApiAdapter.put(`/v1/user/${userId}/credential-password-ip/${credentialPasswordIpId}/ip/${ipId}`, data, {}, {}, axiosClient));
        return response.Response;
    }
}
exports.default = Ip;
