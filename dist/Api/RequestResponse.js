...
class RequestResponse {
    ...
    async get(userId, monetaryAccountId, requestResponseId) {
        ...
        const response = await limiter.run(async (axiosClient) => this.ApiAdapter.get(`/v1/user/${userId}/monetary-account/${monetaryAccountId}/request-response/${requestResponseId}`, {}, {}, axiosClient));
    ...
    async list(userId, monetaryAccountId, options = {
        ...
        const response = await limiter.run(async (axiosClient) => this.ApiAdapter.get(`/v1/user/${userId}/monetary-account/${monetaryAccountId}/request-response`, {}, {
            axiosOptions: {
                params: params
            }
        }, axiosClient));
    ...
    async put(userId, monetaryAccountId, requestResponseId, status, options = {}) {
        ...
        const response = await limiter.run(async (axiosClient) => this.ApiAdapter.put(`/v1/user/${userId}/monetary-account/${monetaryAccountId}/request-response/${requestResponseId}`, requestOptions, {}, {}, axiosClient));
        return response.Response;
    }
}
