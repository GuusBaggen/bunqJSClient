...
class CustomerStatementExport {
    ...
    async post(userId, accountId, statement_format, date_start, date_end, options = {
        ...
        const response = await limiter.run(async (axiosClient) => this.ApiAdapter.post(`/v1/user/${userId}/monetary-account/${accountId}/customer-statement/`, {
    ...
    async get(userId, accountId, customerStatementId, options = {}) {
        ...
        const response = await limiter.run(async (axiosClient) => this.ApiAdapter.get(`/v1/user/${userId}/monetary-account/${accountId}/customer-statement/${customerStatementId}`, {}, {}, axiosClient));
        return response.Response[0];
    }
    /**
     * @param {number} userId
    ...
    async delete(userId, accountId, customerStatementId, options = {}) {
        ...
        const response = await limiter.run(async (axiosClient) => this.ApiAdapter.delete(`/v1/user/${userId}/monetary-account/${accountId}/customer-statement/${customerStatementId}`, {}, {}, axiosClient));
    ...
    async list(userId, accountId, options = {}) {
        ...
        const response = await limiter.run(async (axiosClient) => this.ApiAdapter.get(`/v1/user/${userId}/monetary-account/${accountId}/customer-statement`, {}, {}, axiosClient));
        return response.Response;
    }
}
