...
class Event {
    ...
    async get(userId, eventId, options = {}) {
        ...
        const response = await limiter.run(async (axiosClient) => this.ApiAdapter.get(`/v1/user/${userId}/event/${eventId}`, {}, {}, axiosClient));
    ...
    async list(userId, options = {
        ...
        const response = await limiter.run(async (axiosClient) => this.ApiAdapter.get(`/v1/user/${userId}/event`, {}, {
            axiosOptions: {
                params: params
            }
        }, axiosClient));
