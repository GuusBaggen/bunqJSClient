...
class CredentialPasswordIp {
    ...
    async get(userId, credentialPasswordIpId, options = {}) {
        ...
        const response = await limiter.run(async (axiosClient) => this.ApiAdapter.get(`/v1/user/${userId}/credential-password-ip/${credentialPasswordIpId}`, {}, {}, axiosClient));
    ...
    async list(userId, options = {
        ...
        const response = await limiter.run(async (axiosClient) => this.ApiAdapter.get(`/v1/user/${userId}/credential-password-ip`, {}, {
            axiosOptions: {
                params: params
            }
        }, axiosClient));
