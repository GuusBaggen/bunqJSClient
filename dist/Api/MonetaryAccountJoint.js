...
class MonetaryAccountJoint {
    ...
    async get(userId, monetaryAccountJointId, options = {}) {
        ...
        const response = await limiter.run(async (axiosClient) => this.ApiAdapter.get(`/v1/user/${userId}/monetary-account-joint/${monetaryAccountJointId}`, {}, {}, axiosClient));
    ...
    async list(userId, options = {
        ...
        const response = await limiter.run(async (axiosClient) => this.ApiAdapter.get(`/v1/user/${userId}/monetary-account-joint`, {}, {}, axiosClient));
    ...
    async put(userId, accountId, monetaryAccountPutRequest, options = {}) {
        ...
        const response = await limiter.run(async (axiosClient) => this.ApiAdapter.put(`/v1/user/${userId}/monetary-account-joint/${accountId}`, monetaryAccountPutRequest, {}, {}, axiosClient));
        return response.Response;
    }
}
