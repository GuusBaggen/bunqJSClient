...
class MonetaryAccount {
    ...
    async get(userId, monetaryAccountId, options = {}) {
        ...
        const response = await limiter.run(async (axiosClient) => this.ApiAdapter.get(`/v1/user/${userId}/monetary-account/${monetaryAccountId}`, {}, {}, axiosClient));
    ...
    async list(userId, options = {
        ...
        const response = await limiter.run(async (axiosClient) => this.ApiAdapter.get(`/v1/user/${userId}/monetary-account`, {}, {
            axiosOptions: {
                params: params
            }
        }, axiosClient));
