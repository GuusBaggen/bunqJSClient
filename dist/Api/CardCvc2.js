...
class CardCvc2 {
    ...
    async get(userId, cardId, cvc2Id) {
        ...
        const response = await limiter.run(async (axiosClient) => this.ApiAdapter.get(`/v1/user/${userId}/card/${cardId}/generated-cvc2/${cvc2Id}`, {}, {}, axiosClient));
    ...
    async list(userId, cardId, options = {}) {
        ...
        const response = await limiter.run(async (axiosClient) => this.ApiAdapter.get(`/v1/user/${userId}/card/${cardId}/generated-cvc2`, {}, {}, axiosClient));
    ...
    async post(userId, cardId, type = "GENERATED", options = {}) {
        ...
        const response = await limiter.run(async (axiosClient) => this.ApiAdapter.post(`/v1/user/${userId}/card/${cardId}/generated-cvc2`, {
            type: type
