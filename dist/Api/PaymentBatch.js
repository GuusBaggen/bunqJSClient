...
class PaymentBatch {
    ...
    async get(userId, monetaryAccountId, paymentId, options = {}) {
        ...
        const response = await limiter.run(async (axiosClient) => this.ApiAdapter.get(`/v1/user/${userId}/monetary-account/${monetaryAccountId}/payment-batch/${paymentId}`, {}, {}, axiosClient));
    ...
    async list(userId, monetaryAccountId, options = {
        ...
        const response = await limiter.run(async (axiosClient) => this.ApiAdapter.get(`/v1/user/${userId}/monetary-account/${monetaryAccountId}/payment-batch`, {}, {
            axiosOptions: {
                params: params
            }
        }, axiosClient));
    ...
    async post(userId, monetaryAccountId, description, amount, counterpartyAliasCollection, options = {}) {
        ...
        const response = await limiter.run(async (axiosClient) => this.ApiAdapter.post(`/v1/user/${userId}/monetary-account/${monetaryAccountId}/payment-batch`, {
            payments: payments
        }, {}, {}, axiosClient));
        return response.Response;
    }
