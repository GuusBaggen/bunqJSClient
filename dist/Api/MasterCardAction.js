...
class MasterCardAction {
    ...
    async get(userId, monetaryAccountId, masterCardActionId) {
        ...
        const response = await limiter.run(async (axiosClient) => this.ApiAdapter.get(`/v1/user/${userId}/monetary-account/${monetaryAccountId}/mastercard-action/${masterCardActionId}`, {}, {}, axiosClient));
    ...
    async list(userId, monetaryAccountId, options = {
        ...
        const response = await limiter.run(async (axiosClient) => this.ApiAdapter.get(`/v1/user/${userId}/monetary-account/${monetaryAccountId}/mastercard-action`, {}, {
            axiosOptions: {
                params: params
            }
        }, axiosClient));
