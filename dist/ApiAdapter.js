...
class ApiAdapter {
    constructor(Session, loggerInterface, BunqJSClient) {
        ...
        this.RequestLimitFactory = new RequestLimitFactory_1.default(this.logger);
     ...
     * @returns {Promise<void>}
     */
    async get(url, headers = {}, options = {}, axiosInstance = false) {
     ...
     * @returns {Promise<void>}
     */
    async delete(url, headers = {}, options = {}, axiosInstance = false) {
     ...
     * @returns {Promise<void>}
     */
    async post(url, data = {}, headers = {}, options = {}, axiosInstance = false) {
     ...
     * @returns {Promise<void>}
     */
    async put(url, data = {}, headers = {}, options = {}, axiosInstance = false) {
     ...
     * @returns {Promise<any>}
     */
    async request(url, method = "GET", data = {}, headers = {}, options = {}, axiosInstance = false) {
